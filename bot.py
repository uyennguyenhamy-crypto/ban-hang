...
class ConfirmView(discord.ui.View):
    ...
    async def confirm(
        ...
        if not isinstance(
            ...
            await interaction.response.edit_message(
                content=(
                    ...
                    "ID này phải là ID của **Category**, "
                    "không phải kênh text."
                ),
                embed=None,
                view=None,
            )
        ...
        try:
            ...
            print(
                f"[TICKET] Discord API error: {e}"
            )

            await interaction.response.edit_message(
                content=(
                    "❌ Discord không thể tạo ticket. "
                    "Xem Logs Railway."
                ),
                embed=None,
                view=None,
...
class TicketView(discord.ui.View):
    ...
    async def close(
        ...
        # CHỈ ROLE 1545776328937185300
        # hoặc Administrator được đóng ticket
...
async def refresh_shop(
    ...
    try:
        ...
        print(
            "[SHOP] Đã tạo bảng shop."
        )

    except discord.Forbidden:

        print(
            "[SHOP] Bot thiếu quyền "
