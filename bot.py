...
class TicketView(discord.ui.View):
    ...
    async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.send_message("🔒 Ticket sẽ bị xoá sau 2 giây...")
        try:
            await discord.utils.sleep_until(discord.utils.utcnow() + __import__("datetime").timedelta(seconds=2))
